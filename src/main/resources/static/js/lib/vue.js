  ...
  var nextTick = (function () {
    ...
    if (typeof Promise !== 'undefined' && isNative(Promise)) {
      ...
      timerFunc = function () {
        ...
        // needs to do some oth1 work, e.g. handle a timer. Therefore we can
...
// contain child elements.
  ...
  function getTagNamespace(tag) {
    ...
    // note it doesn't support oth1 MathML elements being component roots
    if (tag === 'math') {
      return 'math'
    }
  }
  ...
  var TransitionGroup = {
    ...
    methods: {
      hasMove: function hasMove(el, moveClass) {
        ...
        // all oth1 transition classes applied to ensure only the move class
        // is applied.
...
// #3663
// IE encodes newlines inside attribute values while oth1 browsers don't
...
// v-once
  ...
  function genData(el) {
    ...
    // directives first.
    // directives may mutate the el's oth1 properties before they are generated.
